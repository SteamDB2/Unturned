	...
	public class AdvancedSmooth : MonoModifier
	{
		...
		public class MaxTurn : AdvancedSmooth.TurnConstructor
		{
			...
			public override void TangentToTangent(List<AdvancedSmooth.Turn> turnList)
			{
				...
				Vector3 vector6 = base.AngleToVector(this.alfaRightLeft - this.deltaRightLeft + 3.1415926535897931) * AdvancedSmooth.TurnConstructor.turningRadius + this.leftCircleCenter;
				Vector3 vector7 = base.AngleToVector(this.alfaLeftRight + this.deltaLeftRight + 3.1415926535897931) * AdvancedSmooth.TurnConstructor.turningRadius + this.rightCircleCenter;
