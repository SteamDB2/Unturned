...
namespace Pathfinding.Voxels
{
	public class Voxelize
	{
		...
		public void VoxelizeInput()
		{
			...
			Matrix4x4 matrix4x = Matrix4x4.Scale(new Vector3(num, num2, num)) * Matrix4x4.TRS(-min, Quaternion.identity, Vector3.one);
			for (int j = 0; j < this.inputExtraMeshes.Count; j++)
			{
				...
				{
					Matrix4x4 matrix4x2 = extraMesh.matrix;
					...
					{
						array6[k] = matrix4x2.MultiplyPoint3x4(vertices[k]);
					}
