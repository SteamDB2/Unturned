...
namespace Pathfinding
{
	public class TargetMover : MonoBehaviour
	{
		...
		public void OnGUI()
		{
			if (this.onlyOnDoubleClick && this.cam != null && Event.current.type == null && Event.current.clickCount == 2)
			{
		...
		public void UpdateTargetPosition()
		{
			...
			if (Physics.Raycast(this.cam.ScreenPointToRay(Input.mousePosition), ref raycastHit, float.PositiveInfinity, this.mask) && raycastHit.point != this.target.position)
			{
